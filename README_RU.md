...
Данный репозиторий предназначен скорее **для демонстрации**.
...
| [mwwm](https://pub.dev/packages/mwwm) | Библиотека с компонентами архитектуры MWWM | release |
| [push_notification](https://pub.dev/packages/push_notification) | Библиотека для работы с уведомлениями | surf |
| [relation](https://pub.dev/packages/relation) | Связь Widget - Wm , используемая в Surf | release |
...
Задать интересующие вопросы можно либо в [Issue](https://github.com/surfstudio/SurfGear/issues) или [Discussion](https://github.com/surfstudio/SurfGear/discussions) к репозиторию, либо в специальном [Telegram чате](https://t.me/SurfGear).
