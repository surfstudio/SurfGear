...
mixin ScenarioHelpMixin {
		...
		Map<String, dynamic> getHelp(ArgParser argParser, [String nameSubCommand]) {
				return <String, dynamic>{
						nameSubCommand ?? getCommandName: nameSubCommand == null ? nameSubCommand ?? getCommandName : nameSubCommand == null ? getCommandsHelp()[getCommandName] : getCommandsHelp()[nameSubCommand],
